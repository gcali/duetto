...
export class Gameplay {
    public playWord(word: FullWord, {player, currentPlayer}: PlayerState): {state: CardState; nextPlayer: Player | null} {
        ...
        return {state, nextPlayer: type === "green" ? currentPlayer : (type === "black" ? null : this.otherPlayer(currentPlayer))};
    }
